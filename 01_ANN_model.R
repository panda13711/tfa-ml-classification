...
cat("ARTIFICIAL NEURAL NETWORK (ANN) MODEL\n")
cat(paste(rep("=", 80), collapse=""), "\n\n")
...
write.csv(results, "results_ANN.csv", row.names=FALSE)
cat("Results saved to results_ANN.csv\n\n")
