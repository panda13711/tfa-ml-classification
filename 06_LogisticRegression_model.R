...
cat("\n")
cat(paste(rep("=", 80), collapse=""), "\n")
cat("SUMMARY - LOGISTIC REGRESSION MODEL RESULTS\n")
cat(paste(rep("=", 80), collapse=""), "\n")
...
write.csv(results, "results_LogisticRegression.csv", row.names=FALSE)
cat("Results saved to results_LogisticRegression.csv\n\n")
